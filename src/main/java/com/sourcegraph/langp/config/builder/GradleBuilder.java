...
public class GradleBuilder {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(GradleBuilder.class);
    ...
    public static boolean prepare(Path path) {
        ...
        Map<String, JavacConfig> configurations = new HashMap<>();
        ...
        for (Path descriptor : descriptors) {
            ...
            for (Map.Entry<String, JavacConfig> entry : configurations.entrySet()) {
                JavacConfig configuration = entry.getValue();
    ...
    private static Collection<Project> collectMetaInformation(Path root, Path descriptor) {
        ...
        try {
            ...
            try {
                InputStream inputStream = GradleBuilder.class.getResourceAsStream(TASK_CODE_RESOURCE);
